...
const FIXTURE_APPOINTMENTS = [
  { id: 1, patient_name: "Alice", visit_type: "OP", department: "Cardiology", doctor_name: "Dr. Rao", appointment_date: "2026-07-26T09:00:00", token_no: 1, status: "scheduled" },
  { id: 2, patient_name: "Bob", visit_type: "OP", department: "Orthopedics", doctor_name: "Dr. Iyer", appointment_date: "2026-07-26T09:30:00", token_no: 2, status: "checked_in" },
];
...
describe("QueuePage", () => {
  test("derives filter options from loaded appointments and updates status on check-in", async () => {
    ...
    const checkInButton = Array.from(container.querySelectorAll("button")).find((btn) => btn.textContent === "Check In");
