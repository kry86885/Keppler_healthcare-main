...
const LOGIN_COPY: Record<LoginType, { heading: string; subtext: string; placeholder: string; submitLabel: string }> = {
  staff: {
  ...
  admin: {
    ...
    subtext: "Sign in to manage employees, hospital settings, and access controls.",
    ...
    <div className="auth-page auth-page-split">
      ...
      <div className="auth-brand-panel">
        <div className="auth-brand-panel-content">
          <img className="auth-brand-logo" src="/logo.png" alt="HospAI - AI Driven Healthcare Optimization" />
          <h2 className="auth-brand-headline">
            <span className="auth-brand-headline-line">Smarter Healthcare.</span>
            <span className="auth-brand-headline-line auth-brand-headline-accent">Better Outcomes.</span>
          </h2>
          <p className="auth-brand-subtext">
            Manage patients, streamline OP/IP operations, and deliver AI-assisted care -- all from one platform.
          </p>
      ...
      <div className="auth-form-panel">
        <div className="auth-card">
          <div className="auth-type-tabs" role="tablist" aria-label="Login type">
            {LOGIN_TABS.map(({ type, label, icon: Icon }) => (
              <button
                ...
                className={loginType === type ? "auth-type-tab active" : "auth-type-tab"}
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <Label>
              ...
              <span className="auth-input-group">
                ...
                <Input name="username" placeholder={copy.placeholder} disabled={submitting} required />
              </span>
            </Label>
            <Label>
              Password
            ...
            <Button type="submit" variant="primary" className="auth-submit" disabled={submitting}>
              {submitting ? (
                <>
                  <FiLoader className="auth-spinner" aria-hidden /> Signing in...
                </>
              ) : (
                copy.submitLabel
              )}
